...
class Std_info():
       def __init__(self, master):
              self.master = master
              self.master.title('Employee Recruitment System')
               ...
               #==========================================================Functions====================================================================
                     def StudentRec(event):
                            try: 
                                   ...
                                   self.Entry_job.insert(END, selected_tuple[2])
                                   self.Entry_educational.delete(0, END)
                                   self.Entry_educational.insert(END, selected_tuple[3])
                     ...
                     def Add():
                            if(len(self.name.get()) != 0):
                               Std_info_BackEnd.insert(self.name.get(), self.Job.get(), self.educational.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), \
                                                       self.gender.get())
                               self.listbox.delete(0, END)
                               self.listbox.insert(END, (self.name.get(), self.Job.get(), self.educational.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), \
                                                       self.gender.get()))
                     ...
                     def Search():
                            self.listbox.delete(0, END)
                            for row in Std_info_BackEnd.search(self.name.get(), self.Job.get(), self.educational.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(),self.gender.get()):
                                   self.listbox.insert(END, row, str(' '))
                     ...
                     self.Label_Job = Label(self.Frame_1, text = 'Job Applied', font = ('arial',20,'bold'),  bg = 'lightblue')
                     self.Label_Job.grid(row = 1, column = 0, sticky = W, padx = 20)
                     self.Label_educational = Label(self.Frame_1, text = 'Educational Qualification', font = ('arial',20,'bold'),  bg = 'lightblue')
                     self.Label_educational.grid(row = 2, column = 0, sticky = W, padx = 20)
                     ...
                     self.Entry_Job = Entry(self.Frame_1, font = ('arial',17,'bold'), textvariable = self.Job)
                     self.Entry_Job.grid(row = 1, column = 1, padx = 10, pady = 5)
                     self.Entry_educational = Entry(self.Frame_1, font = ('arial',17,'bold'), textvariable = self.educational)
                     self.Entry_educational.grid(row = 2, column = 1, padx = 10, pady = 5)
