...
connectiondb = mysql.connector.connect(host="localhost",user="root",passwd="Python@75",database="MYSQL")
cursordb = connectiondb.cursor()

'''cursordb.execute("CREATE TABLE usertable(username VARCHAR(25), password VARCHAR(25))")
sql = "INSERT INTO usertable (username, password) VALUES (%s, %s)"
values = ("shwet","Shwet@75")
